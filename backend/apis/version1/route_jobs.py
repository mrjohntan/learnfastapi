...
def update_job(
    ...
    check = retrieve_job(id=id, db=db)
    # print(check.owner_id, current_user.id, current_user.is_superuser)
    ...
    elif check.owner_id == current_user.id or current_user.is_superuser:
